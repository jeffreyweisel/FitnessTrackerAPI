...
builder.Services.AddAuthentication(CookieAuthenticationDefaults.AuthenticationScheme)
    ...
    {
        options.Cookie.Name = "FitnessTrackerLoginCookie";
...
builder.Services.AddNpgsql<FitnessTrackerDbContext>(builder.Configuration["FitnessTrackerDbConnectionString"]);
